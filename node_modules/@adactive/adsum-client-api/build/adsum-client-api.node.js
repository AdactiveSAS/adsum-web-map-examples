    ...
    value: function cast(classOf, value) {
      ...
      switch (value.constructor.getName()) {
        ...
        case 'Store':
          ...
          break;
        default:
          name = value.constructor.getName();
      }
...
var Place = function (_IsVersionedTrait) {
  ...
  createClass(Place, [{
    ...
    value: function _buildValidators() {
      ...
      this._setPropertyValidator('path_node_id', new AnyValidator([new NullValidator(), new IntegerValidator()]));
      this._setPropertyValidator('position', new VectorValidator());
    }
  }, {
    key: 'keys',
  ...
  createClass(CacheManager, [{
    ...
    value: function getLastPublishDate(siteId, options) {
      ...
      return Request.sendRequest(request).then(function (_ref) {
        ...
        _this.logger.error(message, context);
      ...
      this.runningClean = Promise.all([this._getBinRegistry(), this._readdir(this._getBinCacheDirector())]).then(function (_ref2) {
        ...
        files.forEach(function (file) {
          if (!references.includes(file)) {
            tasks.push(_this2._rmrf(_this2._getBinCacheDirector() + '/' + file));
          }
        });

        return Promise.all(tasks).then(function () {
          _this2.runningClean = null;
        });
      });
    ...
    value: function _cleanUnusedBins(siteId, usedFileReferences) {
      ...
      return this._getBinRegistry().then(function (binRegistry) {
        ...
        return _this3._writeFile(_this3.directory + '/binRegistry.json', JSON.stringify(binRegistry));
      }).then(function () {
        return _this3.clean(false);
      });
    }
    ...
    value: function update(siteId, options) {
      ...
      if (this.runningClean !== null) {
        return this.runningClean.then(function () {
          return _this4.update(siteId, options);
        });
      }
      ...
      var promise = this.needsUpdate(siteId, opts).then(function (_ref4) {
        ...
        if (needsUpdate) {
          ...
          return _this4._doUpdate(siteId, opts);
        }
      ...
      promise.then(function () {
        _this4.runningUpdates.delete(siteId);
      });
    ...
    value: function get$$1(name, emOptions) {
      ...
      return this.getCacheMetadata(emOpts.site).then(function (metadata) {
        ...
        if (!allowOutdated) {
          return _this5.getLastPublishDate(emOpts.site, emOpts).then(function (lastPublishedDate) {
        ...
        var filePath = null;
        if (isDefaultLocale || !_this5.constructor.getTranslatableRepositories().includes(name)) {
          filePath = _this5._getSiteCacheDirector(emOpts.site) + '/' + name + '.json';
        } else {
          filePath = _this5._getSiteCacheDirector(emOpts.site) + '/' + emOpts.locale + '/' + name + '.json';
        }

        var binRegistryPromise = null;
        if (name === File.getName()) {
          binRegistryPromise = _this5._getBinRegistry();
        }

        return Promise.all([_this5._readFile(filePath).then(function (data) {
          return JSON.parse(data);
        }), binRegistryPromise]);
      }).then(function (_ref7) {
        ...
        if (name === File.getName()) {
          ...
          data.forEach(function (file) {
            ...
            // eslint-disable-next-line no-param-reassign
            file.uri = _this5._getBinCacheDirector() + '/' + file.reference;
          });
        }
    ...
    value: function _doUpdate(siteId, options) {
      ...
      return defaultEm.load().then(function () {
        ...
        additionalLocales.forEach(function (locale) {
          var em = _this6._createEm(siteId, locale, options);
          additionalEms.push(em);
          _this6.constructor.getTranslatableRepositories().forEach(function (translatableEntity) {
        ...
        return _this6._rmrf(dest);
      }).then(function () {
        console.log('Creating dirs');
        var tasks = [_this6._mkdirp(dest), _this6._mkdirp(_this6._getBinCacheDirector())];

        additionalEms.forEach(function (em) {
          tasks.push(_this6._mkdirp(dest + '/' + em.locale));
        });
        ...
        return _this6._downloadFiles(defaultEm, binDownloadPolicy);
      }).then(function (fileReferences) {
        console.log('Saving');
        var tasks = [];
        defaultEm.getRepositories().forEach(function (repository) {
          if (repository.isLoaded()) {
            tasks.push(_this6._writeFile(dest + '/' + repository.constructor.getName() + '.json', JSON.stringify(repository.getAll())));
          }
        });
        ...
        additionalEms.forEach(function (em) {
          em.getRepositories().forEach(function (repository) {
            if (repository.isLoaded()) {
              tasks.push(_this6._writeFile(dest + '/' + em.locale + '/' + repository.constructor.getName() + '.json', JSON.stringify(repository.getAll())));
            }
          });
        });
        ...
        return _this6._cleanUnusedBins(siteId, fileReferences);
      }).then(function () {
        var site = defaultEm.getRepository('Site').getCurrent();
        ...
        return _this6._writeFile(dest + '/metadata.json', JSON.stringify(metadata));
      });
    }
    ...
    value: function _downloadFiles(em, binDownloadPolicy) {
      ...
      var _loop = function _loop(_i) {
        ...
        tasks[taskNumber] = tasks[taskNumber].then(function () {
          return _this7._downloadFile(files[_i]);
        });
      };
